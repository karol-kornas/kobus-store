export const PAYMENT_METHODS_BY_SHIPPING: Record<string, readonly string[]> = {
  ...
  "flexible_shipping_single:13": ["przelewy24_extra_154", "przelewy24", "ppcp-gateway", "bacs"],
  "flexible_shipping_single:16": ["przelewy24_extra_154", "przelewy24", "ppcp-gateway", "bacs"],
};
